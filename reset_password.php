...
<body id="d">
    ...
    <nav role="navigation" class="navbar navbar-default" style="border-radius:0px; background-color:#041651;">
        ...
        <div class="navbar-header">
            ...
            <a href="index.php" class="navbar-brand"><img class="profile-img" src="images/logo.png"
...
<ul class="nav nav-tabs" style="background-color:#eee; padding:2px;">
			<li class="active">
        <a  href="#1" data-toggle="tab"><i class="fa fa-info-circle" aria-hidden="true"></i> Reset Password</a>
			</li>
        ...
        <div class="container-fluid" >
          ...
          <form method="post" action="process_rest_password.php" enctype="multipart/form-data">
