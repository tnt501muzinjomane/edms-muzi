...
<body id="d">
    ...
    <nav role="navigation" class="navbar navbar-default" style="border-radius:0px; background-color:#041651;">
        ...
        <div id="navbarCollapse" class="collapse navbar-collapse">
           ...
           <li class="dropdown"  >
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button"><img src="<?php echo $row1['path']; ?>" width="25px" height="25px" class="img-circle" title="<?php echo $row1['name']; ?> <?php echo $row1['surname']; ?>" /> <span class="caret"></span></a>
...
<ul class="nav nav-tabs" style="background-color:#eee; padding:2px;">
        ...
        <div class="container-fluid" >
			...
			<div class="tab-content ">
              ...
              <div class="col-md-8">
        <div id="p" class="divb">
           <form  method="post" action="update_details_doc.php" enctype="multipart/form-data" >
