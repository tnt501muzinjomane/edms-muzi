...
<ul class="nav nav-tabs" style="background-color:#eee; padding:2px;">
        ...
        <div id="p" class="divb">
             ...
             <tr><td>Date</td><td><?php echo $row['doc_date']; ?></td></tr>
             
             </table>
             <table class="table table-striped">
             <tr style="background-color:#eee;"><td>Description</td><td></td></tr>
             <tr><td><?php echo $row['description']; ?></td><td></td></tr>
             <tr><td></td><td> <a href='edit_basis.php?id=<?php echo $row['id'] ?>' class='btn btn-info btn-xs'> <i class='fa fa-pencil' aria-hidden='true'></i> edit details  </a> </td></tr>
             </table>
			 </div>
             ...
             <div id="p" class="divb">
             <form method="post" action="editdoc.php" enctype="multipart/form-data">
    ...
    <select name="cat_id" id="cat_id" class="form-control" required="required" >
             ...
             <br />
              ...
              <hr />
             <form method="post" action="processadd.php" enctype="multipart/form-data">
             ...
             <br /><br />
              ...
              <li> Normal Staff Rights: <?php if($row['lo'] == 1) {echo "YES"; }else{echo "NO";}?>
              <hr />
             <form method="post" action="processremove.php" enctype="multipart/form-data">
             <input type="hidden" name="id"  id="id" value="<?php echo $row['id']; ?>"  required="required" >
